...
class DatasetRecord{
    ...
    public:
        ...
        float ts(){ return _ts; }
        Vector3d pose(){ return _pose;}
        Vector3d offset(){return _offset;}
        float range_min(){return _range_min;}
        float range_max(){return _range_max;}
        float angle_min(){return _angle_min;}
        float angle_max(){return _angle_max;}
        size_t n_beams(){return _n_beams;}
...
class Dataset{
    ...
    public:
        ...
        ~Dataset(){}
        vector<DatasetRecord> records(){return _records;}
        size_t num_records(){return _num_records;}
